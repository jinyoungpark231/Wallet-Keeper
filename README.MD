# <img src="https://github.com/KDT1-FE/KDT5-M6/assets/122417731/fe3cbd44-e412-4e3d-bb2f-87de1016af3c" width="40" height="40"  margin-top="100"> Wallet Keeper
...
|                                                        **메인 페이지**                                                        |                                                           **수입 추가**                                                           |
| :---------------------------------------------------------------------------------------------------------------------------: | :-------------------------------------------------------------------------------------------------------------------------------: |
| <img src="./src/assets/readmeImages/image1.png" width=460px alt="메인" /> | <img src="./src/assets/readmeImages/image2.png" width=460px alt="수입추가" /> |

|                                                           **지출 추가**                                                           |                                                           **전체 내역 검색(전체)**                                                           |
| :-------------------------------------------------------------------------------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------: |
| <img src="./src/assets/readmeImages/image3.png" width=460px alt="지출추가" /> | <img src="./src/assets/readmeImages/image4.png" width=460px alt="전체 내역 검색-전체" /> |

|                                                     **전체 내역 검색(수입)**                                                      |                                                    **전체 내역 검색(지출)**                                                     |
| :-------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------: |
| <img src="./src/assets/readmeImages/image5.png" width=460px alt="지출추가" /> | <img src="./src/assets/readmeImages/image6.png" width=460px alt="어바웃" /> |

**차트 부분**<br/><br/>

  <img src="./src/assets/readmeImages/image7.png" width=1678px alt="차트 부분" />
